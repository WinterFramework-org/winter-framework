...
public class BeanDefinition {
    ...
    public BeanDefinition(Class<?> beanClass) {
        this(beanClass, ScopeType.SINGLETON);
    }

    public BeanDefinition(Class<?> beanClass, ScopeType scope) {
        this(beanClass, scope, null, null);
    }

    public BeanDefinition(Class<?> beanClass, String factoryBeanName, String factoryMethodName) {
        this(beanClass, ScopeType.SINGLETON, factoryBeanName, factoryMethodName);
    }
     ...
     */
    public BeanDefinition(Class<?> beanClass, ScopeType scope, String factoryBeanName, String factoryMethodName) {
